...
%
%        $Id:$ 
%      usage: somLeftRightCrossed()
%         by: cameron mckenzie (edited from justin gardner 'somdis')
%       date: 06/22/15
%    purpose: Tactile Timing Judgment With Crossed Hands
%
...
function myscreen = somLeftRightCrossed()
...
task{1}.numBlocks = 8; %12 blocks per session
